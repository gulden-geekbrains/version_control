...
* В появившемся окне нажать на зелёную кнопку **New** либо на стрелочку рядом с плюсом. Далее выбрать **New repository**. 
* Ввести имя репозитория, при необходимости добавить объяснение, нажать на зелёную кнопку **Create repository**. 
* Если при создании репозитория в предыдущем окне была поставлена галочка возле **Add a README file**, то в появившемся окне нажать на зелёную кнопку **Code**. Далее выбрать закладку **Local**, далее закладку **HTTPS**, нажать на символ **«скопировать»** справа от ссылки на репозиторий.
* Если при создании репозитория галочка возле **Add a README file** не была поставлена, то в появившемся окне выбрать **HTTPS** и нажать на символ **«скопировать»** справа от ссылки на репозиторий.
...
* Кликнуть название файла, в котором требуется внести изменения. 
* В открывшемся окне нажать на символ **«редактировать»**. 
* Внести изменения и нажать на зелёную кнопку **Commit changes**. В открывшемся поле ввести описание изменения также, как и при наборе **git commit -m "message"**. 
...
* В открывшемся окне задать имя репозитория. При необходимости добавить объяснение. Убрать галочку возле **"Сopy the ```main``` branch only"**, в противном случае скопируется только ветка ```main```. Нажать на зелёную кнопку **Create fork**. 
* После этого ответвление чужого удалённого репозитория скопируется в мой. Далее выполняется знакомая последовательность: в появившемся окне нажать на зелёную кнопку **Code**, далее выбрать закладку **Local**, далее закладку **HTTPS**, нажать на символ **«скопировать»** справа от ссылки на репозиторий. 
